function renderProfile(c) {
    ...
    var avatar = u.avatar || getDefaultAvatar(name);
        ...
        '<div class="profile-container">' +
            ...
            '<div class="profile-header">' +
                '<div class="profile-avatar-wrap">' +
                    '<img src="' + avatar + '" class="profile-avatar" onerror="this.src=\'' + getDefaultAvatar(name) + '\'">' +
            ...
            '<div class="profile-stats-card">' +
                '<div class="profile-stats-row">' +
                    '<div class="profile-stat-item">' +
                        '<span class="ps-value gold">💰 ' + coins + '</span>' +
                        '<span class="ps-label">Coins</span>' +
                    '</div>' +
                    '<div class="profile-stat-item">' +
                        '<span class="ps-value blue">⚡ ' + xp + '</span>' +
                        '<span class="ps-label">XP</span>' +
                    '</div>' +
                    '<div class="profile-stat-item">' +
                        '<span class="ps-value green">Lv.' + level + '</span>' +
                        '<span class="ps-label">' + title + '</span>' +
                    '</div>' +
                    '<div class="profile-stat-item">' +
                        '<span class="ps-value gold">' + achievements + '</span>' +
                        '<span class="ps-label">🏆 Badges</span>' +
                    '</div>' +
                '</div>' +
...
function showBlockedUsers() {
    ...
    var h = '<h2 style="color:#D4AF37;margin-bottom:15px">🚫 Blocked Users</h2>';
    if (blocked.length === 0) {
