...
function showForgotPassword() {
    ...
    document.getElementById('genericContent').innerHTML = 
        '<h2 style="color:var(--gold);margin-bottom:15px">🔑 Reset Password</h2>' +
...
function login() {
    ...
    auth.signInWithEmailAndPassword(e, p).catch(function(x) {
        showToast(x.message.replace('Firebase: ', ''), 'error');
    });
}
